...
import { signInWithEmail, signInWithGoogle, signInWithApple } from '@k9-genius/db/client';
        ...
        <div className="bg-white rounded-lg border border-cream-100 shadow-sm p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-teal-400 font-body">
              Sign in to your K9 Genius account
            </p>
          </div>
          ...
          <form onSubmit={handleSignIn} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label
                  htmlFor="password"
                  className="block text-sm font-semibold font-heading text-teal-900"
                >
                  Password
                </label>
                <Link
                  href="/forgot-password"
                  className="text-sm text-coral-500 hover:text-coral-600 font-body transition-colors"
                >
                  Forgot?
                </Link>
              </div>
